...
print('-----------------------------')
print('상태 0에서 push해서 상태0으로 되며, 셀룰러에서 셀룰러로 변경될 확률')
print(P(0, 1, 0, 0, 0))
print('상태 0에서 egg를 해서 상태0이 되며, 셀룰러에서 와이파이로 변경될 확률')
print(P(0, 1, 0, 0, 1))
print('상태 0에서 push해서 상태1으로 되며, 셀룰러에서 셀룰러로 변경될 확률')
print(P(0, 1, 1, 0, 0))
print('상태 0에서 egg를 해서 상태1이 되며, 셀룰러에서 와이파이로 변경될 확률')
print(P(0, 1, 1, 0, 1))
print('총합')
print((P1(0, 1, 0) * P2(0, 0)) + (P1(0, 1, 0) * P2(0, 1)) + (P1(0, 1, 1) * P2(0, 0)) + (P1(0, 1, 1) * P2(1, 1)))
print('-----------------------------')


print('-----------------------------')
print('상태 1에서 push해서 상태1으로 되며, 셀룰러에서 셀룰러로 변경될 확률')
print(P1(1, 0, 1) * P2(0, 0))
print('상태 1에서 egg를 해서 상태1이 되며, 셀룰러에서 와이파이로 변경될 확률')
print(P1(1, 0, 1) * P2(0, 1))
print('상태 1에서 push해서 상태2으로 되며, 셀룰러에서 셀룰러로 변경될 확률')
print(P1(1, 0, 2) * P2(0, 0))
print('상태 1에서 egg를 해서 상태2이 되며, 셀룰러에서 와이파이로 변경될 확률')
print(P1(1, 0, 2) * P2(0, 1))
print('총합')
print((P1(1, 0, 1) * P2(0, 0)) + (P1(1, 0, 1) * P2(0, 1)) + (P1(1, 0, 2) * P2(0, 0)) + (P1(1, 0, 2) * P2(0, 1)))
print('-----------------------------')


print('-----------------------------')
print('상태 3에서 push해서 상태3으로 되며, 셀룰러에서 셀룰러로 변경될 확률')
print(P1(3, 0, 3) * P2(0, 0))
print('상태 3에서 egg를 해서 상태3이 되며, 셀룰러에서 와이파이로 변경될 확률')
print(P1(3, 0, 3) * P2(0, 1))
print('상태 3에서 push해서 상태4으로 되며, 셀룰러에서 셀룰러로 변경될 확률')
print(P1(3, 0, 4) * P2(0, 0))
print('상태 3에서 egg를 해서 상태4이 되며, 셀룰러에서 와이파이로 변경될 확률')
print(P1(3, 0, 4) * P2(0, 1))
print('총합')
print((P1(3, 0, 3) * P2(0, 0)) + (P1(3, 0, 3) * P2(0, 1)) + (P1(3, 0, 4) * P2(0, 0)) + (P1(3, 0, 4) * P2(0, 1)))
print('-----------------------------')
